...
const translations = {
  'zh-CN': {
    ...
    configNameLabel: '配置名称（可选）',
    configNamePlaceholder: '用于分享或管理的模板名称',
    saveConfig: '保存配置',
    clearConfig: '清除配置',
    convert: '转换',
    clear: '清除',
  ...
  'en-US': {
    ...
    configNameLabel: 'Config name (optional)',
    configNamePlaceholder: 'Template name for sharing or admin use',
  ...
  'fa': {
    ...
    configNameLabel: 'نام پیکربندی (اختیاری)',
    configNamePlaceholder: 'نامی برای مدیریت یا اشتراک‌گذاری قالب',
  ...
  'ru': {
    ...
    configNameLabel: 'Имя конфигурации (опционально)',
    configNamePlaceholder: 'Имя шаблона для управления или обмена',
